...
function addData(user) {
    rl.question('What category of data do you want to add today (e.g., personal information, banking data, education data, more data): ', (category) => {
        switch (category.toLowerCase()) {
            ...
            case 'more data':
                rl.question('Enter the category of more data: ', (moreCategory) => {
                    rl.question('Name your category: ', (data) => {
...
function saveUserData() {
    ...
    fs.writeFile('users.json', jsonData, (err) => {
        if (err) throw err;
        console.log('Sample user data saved to users.json file.');
    });
}

function startTerminalInterface() {
    console.log('Welcome to our Sample User Creation Terminal Interface! Front-end was takign forever...');
